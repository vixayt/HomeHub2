...
var game_query = `SELECT 
		    ...
		    ts1.field_goal_att as home_field_att,
	            ts1.field_goal_made as home_field_made,
	            ts1.kickoff_ret_yard as home_kick_yard,
		    ts1.kickoff_ret as home_kick_ret,
		    ts1.kickoff_ret_td as home_kick_td,
		    ts1.punt_ret as home_punt_ret,
		    ts1.punt_ret_yard as home_punt_yard,
		    ts1.punt_ret_td as home_punt_td,
		    ts1.tackle_solo as home_tackle_solo,
		    ts1.tackle_assist as home_tackle_ass,
		    ts1.tackle_for_loss as home_tfl,
		    ts1.sack as home_sack,
		    ts1.sack_yard as home_sack_yard,
		    ts1.QB_hurry as home_qb_hurry,
		    ts1.pass_broken as home_pass_broken,
	            ...
	            ts2.field_goal_att as away_field_att,
	            ts2.field_goal_made as away_field_made,
	            ts2.kickoff_ret_yard as away_kick_yard,
	            ts2.kickoff_ret as away_kick_ret,
	            ts2.kickoff_ret_td as away_kick_td,
	            ts2.punt_ret as away_punt_ret,
	            ts2.punt_ret_yard as away_punt_yard,
	            ts2.punt_ret_td as away_punt_td,
	            ts2.tackle_solo as away_tackle_solo,
	            ts2.tackle_assist as away_tackle_ass,
	            ts2.tackle_for_loss as away_tfl,
	            ts2.sack as away_sack,
	            ts2.sack_yard as away_sack_yard,
	            ts2.QB_hurry as away_qb_hurry,
	            ts2.pass_broken as away_pass_broken
                FROM game g
